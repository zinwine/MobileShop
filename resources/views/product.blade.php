            ...
            <div class="row">
                ...
                <div class="col-md-3 sidebar">
                    <div class="list-group side" style="text-align: left">
                        ...
                        <a href="{{url('brand/show/'.$brand->id)}}" class="list-group-item list">{{$brand->brand}}</a>
                            @endforeach
                    </div>
                ...
                <div class="col-md-9">
                    <div class="row title">
                        <legend class="smartTitle">Smart Phone</legend>
                    </div>
                    <hr>
                    <div class="row">
                                        ...
                                        <div class="well">
                                            <div class="flip-container">
                                                <div class="flipper">
                                                    ...
                                                    {{-- <img src="{{asset('/uploads/'.unserialize($product->imgs)[0])}}" alt="" class="back img-responsive"> --}}
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <br>
                                            <a href="{{asset('product/add_cart/'.$product->id)}}"><div class="btn btn-default cart center-block"><i class="fa fa-shopping-cart" style="color: black"></i> <b>Add to cart</b></div></a>
                                            <ul class="list-inline btndetail">
                                                <a href="{{url('single_product/show/'.$product->id)}}"><li title="info"><i class="fa fa-info" style="color: black;"></i></li></a>
                                            </ul>
                                        </div>
                                    </div>
