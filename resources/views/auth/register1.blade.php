                ...
                {{ csrf_field() }}
                    ...
                    <div class="form-group has-success has-feedback">
                        ...
                        <div class="input-group m_form">
                            ...
                            background-color: transparent;border:1px solid green;" name="password_comfirmation">
                        </div>
                    </div>
                    ...
                    <!--<div class="form-group has-success has-feedback">
                        ...
                        <div class="input-group m_form">
                            ...
                            background-color: transparent;border:1px solid green" name="phNumber">
                        </div>
                    </div>-->


                    <!-- <button type="submit" class="btn btn-primary">Submit</button> -->
                        <button type="submit" class="btn regbtn" style="margin-top:50px"  >Register</button>
