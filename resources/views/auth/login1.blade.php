                ...
                <form class="form-inline form">
                    ...
                    <div class="form-group has-success has-feedback">
                        ...
                        <div class="input-group m_form">
                            ...
                            <input type="email" class="form-control" id="a" aria-describedby="inputGroupSuccess3Status" placeholder="Email" style="background-color: transparent;">
                        </div>
                    </div><br><br><br>
                    ...
                    <div class="form-group has-success has-feedback">
                        ...
                        <div class="input-group m_form">
                            ...
                            <input type="password" class="form-control" id="b" aria-describedby="inputGroupSuccess3Status" placeholder="Password" style="background-color: transparent;">
                        </div>
                    </div>
