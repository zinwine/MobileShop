            ...
            <div class="row">
                ...
                <div class="col-md-3 sidebar">
                    <div class="list-group side" style="text-align: left">
                        ...
                        <a href="{{url('computer_brand/show/'.$brand->id)}}" class="list-group-item list">{{$brand->brand}}</a>
                            @endforeach
                    </div>
                    <div class="list-group side" style="text-align: left">
                ...
                <div class="col-md-9">
                    <div class="row title">
                        <legend class="smartTitle">COMPUTER</legend>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        @foreach($products as $product)
                                ...
                                <div class="col-md-4 smphone center-block">
                                    <div class="well">
                                        ...
                                        <br>
                                        <a href="{{url('product/add_cart/'.$product->id)}}"><div class="btn btn-default cart center-block"><i class="fa fa-shopping-cart" style="color: black"></i> <b>Add to cart</b></div></a>
